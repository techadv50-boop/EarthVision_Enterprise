...
ALLOWED="check discover-databases backup cleanup dry-run discover-ojs inventory hash-files stream-objects database-fingerprint dump-databases discover-applications ensure-backup-mysql-user"
