...
from app.routers import admin, analytics, auth, billing, citations, geo, imagery, raster, satellites, predict, aoi_layers
...
app.include_router(aoi_layers.router, prefix=API_PREFIX)
